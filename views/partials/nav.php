            ...
            <div class="flex items-center">
                ...
                <div class="hidden md:block">
                    <div class="ml-10 flex items-baseline space-x-4">
                        ...
                        <a href="/" class="<?= urlIs('/' )? 'bg-gray-900 text-white' : 'text-gray-300'?> rounded-md px-3 hover:bg-gray-700 py-2 text-sm font-medium hover:text-white">Home</a>
                        <a href="/about" class="<?= urlIs('/about') ? 'bg-gray-900 text-white' : 'text-gray-300'?> rounded-md hover:bg-gray-700 px-3 py-2 text-sm font-medium hover:text-white ">About</a>
                        <a href="/notes" class="<?= urlIs('/notes') ? 'bg-gray-900 text-white' : 'text-gray-300'?> rounded-md hover:bg-gray-700 px-3 py-2 text-sm font-medium hover:text-white ">Notes</a>
